...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.8 ms | 5.0 ms (3.3x) |
| **Generazione** | 4052 ms | 563 ms |
| **Totale** | 4068 ms | 568 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.7 ms | 5.0 ms (3.1x) |
| **Generazione** | 4114 ms | 2638 ms |
| **Totale** | 4129 ms | 2643 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 33% | 50% |
...
| **Generazione** | 3125 ms | 5262 ms |
| **Totale** | 3140 ms | 5267 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 50% | 33% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.6 ms | 4.7 ms (3.1x) |
| **Generazione** | 4503 ms | 4759 ms |
| **Totale** | 4518 ms | 4764 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 67% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.0 ms | 5.6 ms (2.7x) |
| **Generazione** | 1915 ms | 3812 ms |
| **Totale** | 1930 ms | 3818 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 50% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 5.1 ms (3.1x) |
| **Generazione** | 2186 ms | 5246 ms |
| **Totale** | 2202 ms | 5251 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 50% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.3 ms | 5.0 ms (3.1x) |
| **Generazione** | 2771 ms | 2726 ms |
| **Totale** | 2786 ms | 2731 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.0 ms | 4.8 ms (3.1x) |
| **Generazione** | 5338 ms | 5285 ms |
| **Totale** | 5353 ms | 5290 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 50% | 83% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.3 ms | 5.0 ms (3.0x) |
| **Generazione** | 5336 ms | 5183 ms |
| **Totale** | 5352 ms | 5188 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 83% | 67% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.8 ms | 5.0 ms (3.2x) |
| **Generazione** | 980 ms | 680 ms |
| **Totale** | 996 ms | 685 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.9 ms | 4.7 ms (3.2x) |
| **Generazione** | 458 ms | 366 ms |
| **Totale** | 473 ms | 371 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 14% | 0% |
...
| **Generazione** | 452 ms | 407 ms |
| **Totale** | 468 ms | 411 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.7 ms | 4.9 ms (3.0x) |
| **Generazione** | 427 ms | 384 ms |
| **Totale** | 442 ms | 389 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 0% | 14% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.9 ms | 4.9 ms (3.3x) |
| **Generazione** | 461 ms | 401 ms |
| **Totale** | 476 ms | 405 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 5.4 ms (2.8x) |
| **Generazione** | 481 ms | 485 ms |
| **Totale** | 497 ms | 490 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 0% | 14% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.4 ms | 4.9 ms (3.1x) |
| **Generazione** | 484 ms | 485 ms |
| **Totale** | 499 ms | 490 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 0% | 0% |
...
| **Generazione** | 544 ms | 409 ms |
| **Totale** | 559 ms | 413 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 17% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.4 ms | 6.0 ms (2.6x) |
| **Generazione** | 479 ms | 543 ms |
| **Totale** | 495 ms | 549 ms |
| **Pool chunk** | 181 | 16 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.9 ms | 4.5 ms (3.3x) |
| **Generazione** | 1462 ms | 400 ms |
| **Totale** | 1476 ms | 405 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 17% | 0% |
...
| **Generazione** | 461 ms | 453 ms |
| **Totale** | 477 ms | 458 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 33% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.6 ms | 4.9 ms (3.0x) |
| **Generazione** | 1590 ms | 418 ms |
| **Totale** | 1605 ms | 423 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 67% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 4.8 ms (3.2x) |
| **Generazione** | 1440 ms | 1452 ms |
| **Totale** | 1455 ms | 1457 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 100% | 100% |
...
| **Generazione** | 510 ms | 429 ms |
| **Totale** | 526 ms | 434 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 33% | 17% |
...
|---|---|---|
| **Retrieval** | 15.9 ms | 5.1 ms (3.1x) |
| **Generazione** | 553 ms | 447 ms |
| **Totale** | 569 ms | 452 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 17% | 33% |
...
|---|---|---|
| **Retrieval** | 15.4 ms | 4.9 ms (3.1x) |
| **Generazione** | 1740 ms | 1680 ms |
| **Totale** | 1756 ms | 1685 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 17% | 17% |
...
| **Generazione** | 1469 ms | 449 ms |
| **Totale** | 1484 ms | 454 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 60% | 20% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.8 ms | 4.4 ms (3.6x) |
| **Generazione** | 5375 ms | 5267 ms |
| **Totale** | 5391 ms | 5272 ms |
| **Pool chunk** | 181 | 3 |
| **Keyword hit** | 100% | 83% |
...
| **Generazione** | 424 ms | 460 ms |
| **Totale** | 440 ms | 465 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 50% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.1 ms | 5.1 ms (3.2x) |
| **Generazione** | 3391 ms | 3331 ms |
| **Totale** | 3407 ms | 3336 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 80% | 40% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.0 ms | 4.9 ms (3.3x) |
| **Generazione** | 3961 ms | 5262 ms |
| **Totale** | 3977 ms | 5266 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.5 ms | 7.5 ms (2.2x) |
| **Generazione** | 1730 ms | 1988 ms |
| **Totale** | 1747 ms | 1996 ms |
| **Pool chunk** | 181 | 20 |
| **Keyword hit** | 83% | 67% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 5.2 ms (3.0x) |
| **Generazione** | 2849 ms | 449 ms |
| **Totale** | 2864 ms | 454 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 80% | 40% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.4 ms | 5.3 ms (2.9x) |
| **Generazione** | 5424 ms | 5443 ms |
| **Totale** | 5439 ms | 5448 ms |
| **Pool chunk** | 181 | 9 |
| **Keyword hit** | 33% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.8 ms | 6.0 ms (2.6x) |
| **Generazione** | 5468 ms | 5476 ms |
| **Totale** | 5484 ms | 5482 ms |
| **Pool chunk** | 181 | 17 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 5.1 ms (3.0x) |
| **Generazione** | 5420 ms | 5390 ms |
| **Totale** | 5436 ms | 5395 ms |
| **Pool chunk** | 181 | 8 |
| **Keyword hit** | 100% | 80% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.4 ms | 5.5 ms (2.8x) |
| **Generazione** | 5493 ms | 5396 ms |
| **Totale** | 5509 ms | 5402 ms |
| **Pool chunk** | 181 | 9 |
| **Keyword hit** | 80% | 60% |
...
| **Generazione** | 1630 ms | 556 ms |
| **Totale** | 1646 ms | 561 ms |
| **Pool chunk** | 181 | 8 |
| **Keyword hit** | 67% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.1 ms | 4.7 ms (3.2x) |
| **Generazione** | 2793 ms | 418 ms |
| **Totale** | 2808 ms | 423 ms |
| **Pool chunk** | 181 | 4 |
| **Keyword hit** | 67% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.7 ms | 7.3 ms (2.2x) |
| **Generazione** | 2701 ms | 3013 ms |
| **Totale** | 2716 ms | 3021 ms |
| **Pool chunk** | 181 | 22 |
| **Keyword hit** | 100% | 33% |
