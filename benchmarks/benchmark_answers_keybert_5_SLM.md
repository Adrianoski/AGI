...
|---|---|---|
| Speedup retrieval | — | **2.4x** |
| Pool medio | 181 chunk | 10 chunk (-94%) |
| Keyword hit | 52% | **47%** |
| Overlap medio top-5 | 39% | — |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 17.8 ms | 5.6 ms (3.2x) |
| **Generazione** | 4152 ms | 641 ms |
| **Totale** | 4170 ms | 647 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 100% | 100% |
...
| **Generazione** | 4181 ms | 3652 ms |
| **Totale** | 4198 ms | 3659 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 33% | 50% |
...
Based on the provided context, Carlo V controlled an "enormous and complex empire" that included:

*   **The New World** (territori del nuovo mondo).
*   **Portugal** (specifically mentioned as having a vacant seat, implying it was part of his domains).
*   **Spain** (implied by the conflict with France and the succession to the Spanish throne, though the text explicitly names the New World and Portugal as additional parts).
*   **A large part of Italy**, which became the site of the conflict and where Spanish predominance was established after the Peace of Cateau-Cambrésis (1559).

The text does not provide a specific list of every Italian state under his control, but it notes that the conflict involved Italy as a strategic location for Spanish dominance.
...
| **Generazione** | 3149 ms | 5359 ms |
| **Totale** | 3165 ms | 5365 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 50% | 33% |
...
Le cause della Rivoluzione francese elencate nel contesto sono:

*   **Intervento militare in favore della monarchia francese:** Gli stati europei sembravano pronti a intervenire per ristabilire l'ordine, mettendo in difficoltà l'esercito francese che subì varie sconfitte.
*   **Pressioni degli aristocratici fuggiti all'estero:** Questi avevano fatto pressioni sui sovrani per l'intervento militare.
*   **Voci sul tradimento del re:** A Parigi queste voci erano ormai diffuse.
*   **Crisi economica e sociale:** Il contesto generale (anche se descritto principalmente per l'Italia e l'Europa nel 1848) meniona masse contadine colpite da crisi e piogge, operai espulsi dalle industrie per sovrapproduzione e disoccupazione, e richieste di emancipazione sociale e sostegno economico.
*   **Diffusione dei valori liberali:** I valori liberali propugnati dai patrioti erano ormai diffusi tra ampi strati della popolazione.
*   **Principi della Rivoluzione:** Convergevano nella richiesta di estensione del diritto di voto e, nel caso italiano, di indipendenza ed unificazione (
...
| **Generazione** | 505 ms | 484 ms |
| **Totale** | 521 ms | 489 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 67% | 83% |
...
| **Generazione** | 4569 ms | 5093 ms |
| **Totale** | 4584 ms | 5099 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 67% | 67% |
...
*   **La libertà:** È un principio concreto applicato con la nascita degli Stati Uniti, che si basano sulla libertà e non sulle tradizioni storiche dell'Europa.
*   **I diritti del singolo e del popolo:** L'Illuminismo difende questi diritti contro il despotismo delle autorità.
*   **L'autonomia e la rappresentatività:** Gli americani cercavano una maggiore libertà, indipendenza e rappresentatività politica.
*   **Il coraggio di usare l'intelligenza:** Espresso dal motto di Kant "Sapere aude" (Abbi il coraggio di servirti della tua intelligenza).
*   **L'uscita dallo stato di minorità:** Definizione data da Kant, che indica l'uomo che deve imputare a se stesso la propria minorità.
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.6 ms | 6.1 ms (2.6x) |
| **Generazione** | 1947 ms | 4817 ms |
| **Totale** | 1963 ms | 4823 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 50% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.8 ms | 6.2 ms (2.6x) |
| **Generazione** | 2220 ms | 4943 ms |
| **Totale** | 2236 ms | 4949 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 50% | 83% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.6 ms | 5.3 ms (2.9x) |
| **Generazione** | 2817 ms | 2786 ms |
| **Totale** | 2833 ms | 2791 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 100% | 100% |
...
La riforma protestante di Lutero fu un movimento iniziato da Martin Lutero, monaco e studioso, che si sviluppò a partire dalla pubblicazione delle sue 95 tesi contro le indulgenze e la dottrina tradizionale della Chiesa cattolica. Lutero affermò che per la salvezza dell'anima basta la sola fede e che ogni individuo dispone del libero arbitrio per leggere e interpretare personalmente la Bibbia. Questo cambiamento radicale fu facilitato dalla diffusione della stampa. La Chiesa cattolica reagì scomunicando Lutero nel 1520, dando così inizio alla Riforma.
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.5 ms | 6.5 ms (2.2x) |
| **Generazione** | 5422 ms | 5329 ms |
| **Totale** | 5436 ms | 5336 ms |
| **Pool chunk** | 181 | 11 |
| **Keyword hit** | 50% | 83% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.1 ms | 8.1 ms (2.0x) |
| **Generazione** | 5403 ms | 4900 ms |
| **Totale** | 5419 ms | 4908 ms |
| **Pool chunk** | 181 | 23 |
| **Keyword hit** | 83% | 50% |
...
*   **Condizioni di lavoro precarie:** A causa del grande numero di braccianti che abbandonavano le campagne (anche a causa delle enclosures), i salari erano bassi e le condizioni di lavoro molto pesanti.
*   **Conflitti sociali:** Queste condizioni prepararono i conflitti sociali del 1800.
*   **Impatto specifico in Italia:** Il settore agricolo rimase trainante, ma la crisi portò a una ripresa della produzione industriale solo con dazi doganali che ebbero effetti negativi per il meridione. Questo provocò un' **emigrazione massiccia**, con oltre 5 milioni di persone che abbandonarono l'Italia negli ultimi venti anni del secolo.
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.1 ms | 7.8 ms (1.9x) |
| **Generazione** | 994 ms | 999 ms |
| **Totale** | 1009 ms | 1007 ms |
| **Pool chunk** | 181 | 23 |
| **Keyword hit** | 100% | 100% |
...
| **Generazione** | 460 ms | 448 ms |
| **Totale** | 476 ms | 454 ms |
| **Pool chunk** | 181 | 5 |
| **Keyword hit** | 14% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 6.1 ms (2.5x) |
| **Generazione** | 455 ms | 447 ms |
| **Totale** | 471 ms | 453 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.0 ms | 6.1 ms (2.6x) |
| **Generazione** | 428 ms | 482 ms |
| **Totale** | 444 ms | 489 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 0% | 14% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.6 ms | 6.0 ms (2.6x) |
| **Generazione** | 464 ms | 450 ms |
| **Totale** | 480 ms | 456 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 0% | 0% |
...
| **Generazione** | 486 ms | 506 ms |
| **Totale** | 502 ms | 513 ms |
| **Pool chunk** | 181 | 9 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.2 ms | 6.0 ms (2.7x) |
| **Generazione** | 486 ms | 434 ms |
| **Totale** | 502 ms | 440 ms |
| **Pool chunk** | 181 | 9 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.5 ms | 7.1 ms (2.3x) |
| **Generazione** | 556 ms | 465 ms |
| **Totale** | 573 ms | 472 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 17% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.1 ms | 7.7 ms (2.0x) |
| **Generazione** | 483 ms | 482 ms |
| **Totale** | 498 ms | 490 ms |
| **Pool chunk** | 181 | 18 |
| **Keyword hit** | 0% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 14.8 ms | 5.6 ms (2.6x) |
| **Generazione** | 1477 ms | 428 ms |
| **Totale** | 1491 ms | 433 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 17% | 0% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.9 ms | 5.6 ms (2.9x) |
| **Generazione** | 472 ms | 445 ms |
| **Totale** | 488 ms | 450 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 33% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.7 ms | 6.1 ms (2.6x) |
| **Generazione** | 1600 ms | 462 ms |
| **Totale** | 1615 ms | 468 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 67% | 33% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.1 ms | 6.1 ms (2.6x) |
| **Generazione** | 1456 ms | 1428 ms |
| **Totale** | 1472 ms | 1434 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.2 ms | 5.8 ms (2.8x) |
| **Generazione** | 510 ms | 542 ms |
| **Totale** | 526 ms | 548 ms |
| **Pool chunk** | 181 | 8 |
| **Keyword hit** | 33% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.4 ms | 6.3 ms (2.4x) |
| **Generazione** | 522 ms | 483 ms |
| **Totale** | 537 ms | 490 ms |
| **Pool chunk** | 181 | 8 |
| **Keyword hit** | 17% | 0% |
...
| **Generazione** | 1751 ms | 1708 ms |
| **Totale** | 1766 ms | 1715 ms |
| **Pool chunk** | 181 | 19 |
| **Keyword hit** | 17% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.3 ms | 5.9 ms (2.6x) |
| **Generazione** | 1477 ms | 453 ms |
| **Totale** | 1492 ms | 459 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 60% | 20% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.9 ms | 5.8 ms (2.7x) |
| **Generazione** | 5432 ms | 5408 ms |
| **Totale** | 5447 ms | 5414 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 100% | 100% |
...
In base al contesto fornito, le caratteristiche principali della Prima Rivoluzione Industriale (che si è svolta tra il 1770 e il 1850, con inizio dopo il 1750 in GB) sono:

*   **Cambiamento economico e sociale:** passaggio da un'economia agricola e società chiusa a un'economia basata sulle macchine, sul lavoro operaio e alla nascita di nuove classi sociali.
...
*   **Sviluppo urbano e demografico:** crescita delle città con la formazione di quartieri operai; aumento demografico in Europa (in Inghilterra la popolazione raddoppia in un secolo).
...
| **Generazione** | 427 ms | 462 ms |
| **Totale** | 442 ms | 468 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 50% | 50% |
...
| **Generazione** | 3404 ms | 3227 ms |
| **Totale** | 3418 ms | 3233 ms |
| **Pool chunk** | 181 | 7 |
| **Keyword hit** | 80% | 60% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 5.6 ms (2.8x) |
| **Generazione** | 4010 ms | 5359 ms |
| **Totale** | 4026 ms | 5365 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 0% | 20% |
...
*   **Crisi agraria e carestie:** Determinate da cattivi raccolti e capricci del clima (come nel 1788), che portarono a un aumento del prezzo del pane e a conseguenze sociali gravi.
*   **Inflazione e perdita di potere d'acquisto:** Causata dall'importazione di enormi quantità di oro e argento dalle Americhe (spiegazione di Jean Bodin), che divorò il potere d'acquisto dei salariati.
*   **Situazione finanziaria critica:** Aggravata da attività speculative dei mercanti e da una spesa statale eccessiva ("macchina esosa dello stato").
*   **Politica fiscale di Jacques Turgot:** La imposizione di una tassa sulle terre per reperire risorse, che alienò le simpatie dei proprietari terrieri.
*   **Spesa del lusso della corte:** Il re Luigi XVI sperperava somme ingenti, un fatto reso pubblico dal ministro Necker nel 1781, contribuendo alla crisi finanziaria.
*   **Società divisa in rigidi ordini sociali:** Con persist
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.1 ms | 7.7 ms (1.9x) |
| **Generazione** | 1751 ms | 501 ms |
| **Totale** | 1767 ms | 509 ms |
| **Pool chunk** | 181 | 22 |
| **Keyword hit** | 83% | 50% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.6 ms | 8.2 ms (1.9x) |
| **Generazione** | 2864 ms | 462 ms |
| **Totale** | 2880 ms | 471 ms |
| **Pool chunk** | 181 | 20 |
| **Keyword hit** | 80% | 60% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.6 ms | 9.5 ms (1.7x) |
| **Generazione** | 5385 ms | 5432 ms |
| **Totale** | 5401 ms | 5441 ms |
| **Pool chunk** | 181 | 24 |
| **Keyword hit** | 33% | 67% |
...
*   **Campagna di Russia (1812):** Caratterizzata da una rapida conquista del territorio seguita da una "ritirata invernale disastrosa" dopo che la Russia si dissociò dal blocco contro gli Inglesi.
*   **Sconfitta di Lipsia (1813):** Portò a un primo esilio sull'isola d'Elba.
*   **I 100 giorni:** Dopo la fuga dall'Elba, Napoleone tentò un recupero militare rendendo le leggi più liberali, ma fu sconfitto definitivamente a Waterloo.
*   **Battaglia di Waterloo (1815):** La sconfitta definitiva che cond
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.8 ms | 8.8 ms (1.8x) |
| **Generazione** | 5450 ms | 5482 ms |
| **Totale** | 5466 ms | 5491 ms |
| **Pool chunk** | 181 | 24 |
| **Keyword hit** | 100% | 100% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.2 ms | 7.4 ms (2.1x) |
| **Generazione** | 5419 ms | 4177 ms |
| **Totale** | 5435 ms | 4185 ms |
| **Pool chunk** | 181 | 12 |
| **Keyword hit** | 100% | 80% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 16.2 ms | 7.0 ms (2.3x) |
| **Generazione** | 5513 ms | 5457 ms |
| **Totale** | 5529 ms | 5464 ms |
| **Pool chunk** | 181 | 11 |
| **Keyword hit** | 80% | 60% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.5 ms | 6.2 ms (2.5x) |
| **Generazione** | 1640 ms | 464 ms |
| **Totale** | 1655 ms | 471 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 67% | 17% |
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.2 ms | 6.3 ms (2.4x) |
| **Generazione** | 2823 ms | 2285 ms |
| **Totale** | 2838 ms | 2291 ms |
| **Pool chunk** | 181 | 6 |
| **Keyword hit** | 67% | 33% |
...
La dottrina Monroe fu proclamata nel 1823 (non specificato nel contesto fornito) e significava che il "cordone ombelicale con la vecchia Europa" si stava tagliando, mentre gli Stati Uniti si sentivano legittimati ad intraprendere una politica di egemonia su tutto il continente. In seguito a tale dottrina, nel 1845, furono annessi gli stati della California e del Texas a danno del Messico.
...
| | StdRAG | SLM-RAG |
|---|---|---|
| **Retrieval** | 15.2 ms | 7.7 ms (2.0x) |
| **Generazione** | 2742 ms | 2443 ms |
| **Totale** | 2758 ms | 2450 ms |
| **Pool chunk** | 181 | 24 |
| **Keyword hit** | 100% | 100% |
